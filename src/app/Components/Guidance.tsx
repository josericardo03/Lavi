      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-gray-600">Carregando orientações...</p>
          </div>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Orientações</h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Guias e orientações para o desenvolvimento e uso de ambientes
                ...
                {guidance.links && (
                  <div className="border-t border-gray-100 pt-6">
                    ...
                    <div className="space-y-3">
                      {guidance.links.split(",").map((link, index) => {
                        ...
                        return (
                          <a
                            ...
                            className="flex items-center p-3 bg-gray-50 hover:bg-green-50 rounded-lg transition-all duration-200 group/link"
                          >
                            <svg
                              className="w-5 h-5 text-gray-400 mr-3 group-hover/link:text-green-600 transition-colors"
                              fill="none"
                              stroke="currentColor"
                              viewBox="0 0 24 24"
                            >
                            ...
                            <span className="text-green-600 hover:text-green-700 font-medium group-hover/link:underline">
                              {domain}
                            </span>
                          </a>
                        );
        ...
        {guidances.length === 0 && (
          <div className="text-center py-16">
            ...
            <p className="text-gray-600">
              As orientações serão disponibilizadas em breve.
            </p>
          </div>
        )}
      </div>
